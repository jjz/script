...
if [ ! -z "$VERBOSE" ] && [ "$VERBOSE" != "0" ]; then
  echo "ANDROID_NDK_ROOT: `echo $ANDROID_NDK_ROOT`"
  echo "ANDROID_ARCH: `echo $_ANDROID_ARCH`"
  echo "ANDROID_EABI: `echo $_ANDROID_EABI`"
  echo "ANDROID_API: `echo $ANDROID_API`"
  echo "ANDROID_SYSROOT: `echo $ANDROID_SYSROOT`"
  echo "ANDROID_TOOLCHAIN:`echo $ANDROID_TOOLCHAIN`"
  echo "FIPS_SIG: `echo $FIPS_SIG`"
  echo "CROSS_COMPILE: ` echo $CROSS_COMPILE`"
  echo "ANDROID_DEV: `echo $ANDROID_DEV`"
fi
